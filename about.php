<?
	$title = "О нас";
	$description = "О мебельной фабрике СТОЛЬНИК";
	include "header.php";
?>
...
<section id="main">
	<section class="page">
		...
		<div style="line-height: 1.5em; text-align: justify">
			<p>Стольник - это дружный профессиональный коллектив, который производит для Вас качественные столы и стулья при помощи современного оборудования.</p>
