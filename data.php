...
//		"trumo" => array("Трюмо", "100х62 см", "белый + золотая патина", "ABS-пластик", array(1 => 30000), 1),
	...
	"chair" => array(
		...
		"osvald" => array("Освальд пуговицы", "Ширина: 43 см<br>Высота: 86 см<br>Глубина: 57 см<br>Высота сидения: 45 см", "ольха", "гнутоклееные детали из шпона, металлические трубы", 7600, 1),
		"osvaldromb" => array("Освальд ромб", "Ширина: 43 см<br>Высота: 86 см<br>Глубина: 57 см<br>Высота сидения: 45 см", "ольха", "гнутоклееные детали из шпона, металлические трубы", 7600, 1),
...
//		"ostin-m" => array("Остин-М", "Ширина: 60 см<br>Высота: 84 см<br>Глубина: 50 см<br>Высота сидения: 45 см", "ольха", "гнутоклееные детали из шпона, металлические полозья", 6500, 1),
		...
		"chesterfield" => array("Честерфилд", "Ширина: 160 см<br>Высота: 81 см<br>Глубина: 74 см<br>Высота сидения: 45 см", "венге", "массив", 23000, 1),
